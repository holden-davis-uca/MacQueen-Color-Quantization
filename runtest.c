...
int main(int argc, char **argv)
{
    ...
    for (int i = 1; i < argc; i++)
    {
        ...
        {
            runs = 10;
            printf("No run specification given, using 10 runs");
        }
    }
    FILE *results;
    ...
    for (int z = 0; z < 10; z++)
    {
        ...
        int num_cols_1darray = 0;
        int num_cols_3darray = 0;
        int num_cols_avl = 0;
        int num_cols_rb = 0;
        ...
        for (int y = 0; y < runs; y++)
        {
            ...
            totaladdtime1d += addtime1d;

            start = clock();
            num_cols_1darray = count_colors_1d_histo(histogram1d);
            stop = clock();
            counttime1d = ((double)(stop - start)) / CLOCKS_PER_SEC;
            totalcounttime1d += counttime1d;
            ...
            start = clock();
            num_cols_3darray = count_colors_3d_histo(histogram3d);
            stop = clock();
            ...
            totaladdtimebst += addtimebst;
            start = clock();
            num_cols_bst = traverse_bst(root);
            stop = clock();
            counttimebst = ((double)(stop - start)) / CLOCKS_PER_SEC;
            totalcounttimebst += counttimebst;
            ...
            totaladdtime2dbst += addtime2dbst;
            start = clock();
            num_cols_bst2d = count_colors_2dbst(bst2darray);
            stop = clock();
            counttime2dbst = ((double)(stop - start)) / CLOCKS_PER_SEC;
            totalcounttime2dbst += counttime2dbst;
            // 2-D SLL
            ...
            totaladdtime2dsll += addtime2dsll;
            start = clock();
            num_cols_2dsll = count_colors_2dsll(sll2darray);
            stop = clock();
            counttime2dsll = ((double)(stop - start)) / CLOCKS_PER_SEC;
            totalcounttime2dsll += counttime2dsll;
            ...
            stop = clock();
            num_cols_avl = avltree->avl_count;
            addtimeavl = ((double)(stop - start)) / CLOCKS_PER_SEC;
            totaladdtimeavl += addtimeavl;
            ...
            stop = clock();
            num_cols_rb = rbtree->rb_count;
            addtimerb = ((double)(stop - start)) / CLOCKS_PER_SEC;
            totaladdtimerb += addtimerb;
        ...
        */
        ...
        averageaddtimerb = totaladdtimerb / runs;
        averageaddtimeavl = totaladdtimeavl / runs;
        averageaddtimeht = totaladdtimeht / runs;
        averageaddtime2dsll = totaladdtime2dsll / runs;
        averagecounttime2dsll = totalcounttime2dsll / runs;
        averageaddtime2dbst = totaladdtime2dbst / runs;
        averagecounttime2dbst = totalcounttime2dbst / runs;
        averageaddtimebst = totaladdtimebst / runs;
        averagecounttimebst = totalcounttimebst / runs;
        averageaddtime1d = totaladdtime1d / runs;
        averagecounttime1d = totalcounttime1d / runs;
        averageaddtime3d = totaladdtime3d / runs;
        averagecounttime3d = totalcounttime3d / runs;

        fprintf(results, "\n");
        fprintf(results,
                "%-25s%-25g%-25d%-25zu%-25g%-25d%-25zu%-25g%-25d%-25d%-25g%-25g%-25d%-25g%-25g%-25d%-25g%-25g%-25d%-25g%-25g%-25d%-25g%-25g%-25d",
                in_file_name,
                averageaddtimerb, 0, num_cols_rb,
                averageaddtimeavl, 0, num_cols_avl,
                averageaddtimeht, 0, num_cols_hashtable,
                averageaddtime2dsll, averagecounttime2dsll, num_cols_2dsll,
                averageaddtime2dbst, averagecounttime2dbst, num_cols_bst2d,
                averageaddtimebst, averagecounttimebst, num_cols_bst,
                averageaddtime1d, averagecounttime1d, num_cols_1darray,
                averageaddtime3d, averagecounttime3d, num_cols_3darray);
    }
